...
export default function Dashboard() {
    ...
    const generateLaTeXCode = () => {
        const header = `\\documentclass[11pt, a4paper]{article}
            ...
            % Define Colors
            \\definecolor{lightbg}{rgb}{0.95, 0.94, 0.96}
            \\definecolor{darkpurple}{rgb}{0.3, 0.2, 0.4}
            ...
            \\newcommand{\\sectiontitle}[1]{%
                ...
                \\begin{center}
                    \\begin{tikzpicture}
                        ...
                        \\node[fill=lightbg, text=darkpurple, font=\\Large\\bfseries, minimum width=\\textwidth, inner sep=8pt] (title) {#1};
                        
                        % Top line
                        \\draw[darkpurple, line width=1pt] ([xshift=-5pt]title.north west) -- ([xshift=5pt]title.north east);
                        
                        % Bottom line
                        \\draw[darkpurple, line width=1pt] ([xshift=-5pt]title.south west) -- ([xshift=5pt]title.south east);
                    \\end{tikzpicture}
                \\end{center}
            }
